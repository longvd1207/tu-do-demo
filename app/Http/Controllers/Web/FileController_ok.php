...
class FileController extends Controller
{
    ...
    public function __construct()
    {
        ...
        //thư mục để ảnh giải nén tạm , trước khi copy vào thư mục ảnh nhân viên
...
//        ]);
        ...
        if ($request->file('zip_file')->isValid()) {
            ...
            if ($zip->open(storage_path('app/' . $zipPath)) === true) {
                ...
                //$extractPath = public_path('images/staff_client_send'); // Thư mục đích để giải nén
                $extractPath = $this->extractPath; // Thư mục đích để giải nén
                //xoá hết thư mục temp chứa ảnh
                $this->deleteAllImages($extractPath);
...
*/
    private function resizeImage($imagePath, $destinationPath, $with = 300)
    {
