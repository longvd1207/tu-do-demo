                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <a class="btn btn-primary" href="{{ route('fun-spot.create') }}">
                                    ...
                                    <table class="table table-sm table-bordered align-middle table-nowrap mb-0 "
                                        ...
                                        <thead class="table-light text-muted">
                                            <tr class="text-center">
                                                ...
                                                <th class="sort">Điểm vui chơi</th>
...
{{--                                                                    @can('area.delete')--}}
                                                                        <li class="list-inline-item">
                                                                            <form action="{{ route('fun-spot.destroy', $item['id']) }}" method="post">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button title="Delete"
