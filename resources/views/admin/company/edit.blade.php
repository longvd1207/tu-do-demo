                                ...
                                <div class="col-12">
                                    <div class="form_input">
                                        ...
                                        <input class="form-control" name="code" type="text"
                                               value="{{ $company->code ?? old('code') }}" required>
                                ...
                                <div class="col-12">
                                    <div class="form_input">
                                        ...
                                        <input class="form-control" name="name" type="text"
                                               value="{{ $company->name ?? old('name') }}" placeholder="Nhập tên công ty..." required>
                                        @if ($errors->has('name'))
                                            <div class="bg-danger text-white text-center py-1">
                                ...
                                <div class="col-12">
                                    <div class="form_input">
                                        ...
                                        <input class="form-control" name="address" type="text"
                                               value="{{ $company->address ?? old('address') }}" placeholder="Nhập địa chỉ...">
