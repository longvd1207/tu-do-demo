...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <form action="{{ route('device.store') }}"
                ...
                <div class="card">
                    <div class="card-body border border-dashed border-start-0 border-end-0 row">
                        ...
                        <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="form_input">
                                        ...
                                        <select name="type" onchange="switchType(this.value)" class="form-control"
                                            ...
                                            <option value="3">Điểm vui chơi</option>
                                        </select>
                                        @if ($errors->has('type'))
                            ...
                            <div class="row mb-3">
                                <div class="choose-area select-group col-6 mb-2" style="display: none">
                                ...
                                <div class="choose-service select-group col-6 mb-2" style="display: none">
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" name="service_id" id="search_service_id">
                                            ...
                                            @foreach ($services as $item)
                                                <option value="{{ $item->id }}" id="service_id_{{ $item->id }}">
                                                    {{ @$item->area->name . ' - ' . $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="choose-fun_spot select-group col-6 mb-2" style="display: none">
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" name="fun_spot_id" id="search_fun_spot_id">
                                            ...
                                            @foreach ($fun_spots as $item)
                                                <option value="{{ $item->id }}" id="fun_spot_id_{{ $item->id }}">
                                                    {{ @$item->area->name. ' - ' . $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6 mb-2">
                                    <div class="form_input">
                                        ...
                                        <div id="plus_ip" style="float: right" class="btn btn-outline-success waves-effect waves-light btn-sm btn_plus"><i class="ri-add-line"></i></div>

                                        <div id="ip_container">
                                            <div id="ip_row" style= "align-items: center;">
                                                <input class="form-control" name="ip[]" type="text"
                                                       value="{{ old('ip')}}" placeholder="Nhập địa chỉ ip" required>
                                            </div>
                                        </div>
                                        @if ($errors->has('ip'))
                                            <div class="bg-danger text-white text-center py-1">
