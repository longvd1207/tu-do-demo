                            ...
                            <div class="card-header border-0">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <a class="btn btn-primary" href="{{ route('type_ticket.create') }}">
                                ...
                                <div class="table-responsive  table-card mb-4">
                                    <table class="table table-sm table-bordered align-middle table-nowrap mb-0 "
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <th class="sort">Kiểu bán</th>
                                            <th class="sort">Giá offline (đ)</th>
                                            <th class="sort">Giá online (đ)</th>
                                            <th class="sort" style="width: 15%">Trạng thái</th>
                                            <th style="width: 15%">Thao tác</th>
                                        </tr>
                                        </thead>
                                        <tbody class="list form-check-all">
                                        @isset($type_tickets)
                                            @foreach ($type_tickets as $key => $item)
                                                <tr id="tr_{{ $item['id'] }}">
                                                    ...
                                                    <td style="text-align: right;width: 15%">{{ number_format($item->price_offline) ?? '' }}
                                                    </td>
                                                    <td style="text-align: right;width: 15%">{{ number_format($item->price_online) ?? '' }}
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="flex-shrink-0 ms-4">
                                                            <ul class="list-inline tasks-list-menu mb-0">
                                                                ...
                                                                {{--                                                                    @can('update_type_ticket')--}}
                                                                <li class="list-inline-item">
                                                                    <a class="btn btn-outline-primary btn-sm waves-effect waves-light"
                                                                       href="
                                                                            {{ route('type_ticket.edit', $item['id']) }}"
                                                                       title="Sửa">
                                                                        <i class="ri-pencil-line "></i>
                                                                    </a>
                                                                </li>
                                                                {{--                                                                    @endcan--}}
                                                                {{--                                                                    @can('type_ticket.delete')--}}
                                                                <li class="list-inline-item">

                                                                    <form
                                                                        action="{{ route('type_ticket.destroy', $item['id']) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button title="Delete"
