                                    ...
                                    <div class="form_input">
                                        ...
                                        <select name="status" class="form-control">
                                            <option class="text-success"
                                                    value="1" {{ $service->status === 1 ? 'selected' : '' }}>Hoạt động
                                            </option>
                                            <option class="text-danger"
                                                    value="0" {{ $service->status === 0 ? 'selected' : '' }}>Khóa
                                            </option>
                                        </select>
                                        ...
                                        <select class="form-select" name="area_id" id="search_area_id">
                                            ...
                                            @foreach ($areas as $item)
                                                <option value="{{ $item['id'] }}"
                                                        {{ $service->area_id == $item->id ? 'selected' : '' }} id="area_id_{{ $item['id'] }}">
                                                    {{ $item['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form_input">
                                        ...
                                        <textarea class="form-control" name="description" type="text"
                                                  placeholder="Nhập mô tả...">{{ old('description') ?? $service->description }}</textarea>
